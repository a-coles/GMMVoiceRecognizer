#
#This file extracts MFCCs from the training recording and stores them in the mfccs folder.
#
...
if __name__=='__main__':
    ...
    mfccpath = "/home/2016/acoles/public_html/550uploads/mfcc/"+username+"_train.mfc"
    mfccs = open(mfccpath, "r")
    for line in mfccs:
        print line

	#Let the user continue to callmakegmm.py	
    print "</div></td></table>"
    print "<br><br>"
    print "<form action=\"../cgi-bin/callmakegmm.py\" method=\"post\">"
